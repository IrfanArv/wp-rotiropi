...
class SmartSlider3Info {
    ...
    public static $version = '3.5.1.8';

    public static $channel = 'stable';

    public static $revision = '61fb74ebefe11b43fb064df22d864178d9ea3d9d';

    public static $revisionShort = '61fb74eb';

    public static $branch = 'release-3.5.1.8';
